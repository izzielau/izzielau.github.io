...
function Landing() {
    ...
    return (
        <div class="landing">
            ...
            <div class="row">
                <RectanglePolaroid title="Machine Learning" subtitle="Microsoft" description="Implemented and experimented with various NLP models for Bing in conjunction with the Microsoft Research team." link="/microsoft" image={micr} tag="software"> </RectanglePolaroid>
                <RectanglePolaroid title="COVID-19 Research Project [1st]" subtitle="Blueprint Datathon" description="Published a research paper as the culmination of our team's research and models trained on data about the COVID-19 pandemic." link="/datathon" image={data} tag="software"> </RectanglePolaroid>
